                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="session" class="form-control" name="session">
                                <option value="Session-12" <?php echo ($session == "Session-12") ? 'selected' : ''; ?>>Session-12</option>
                                <option value="Session-11" <?php echo ($session == "Session-11") ? 'selected' : ''; ?>>Session-11</option>
                                <option value="Session-10" <?php echo ($session == "Session-10") ? 'selected' : ''; ?>>Session-10</option>
                                <option value="Session-9" <?php echo ($session == "Session-9") ? 'selected' : ''; ?>>Session-9</option>
                                <option value="Session-8" <?php echo ($session == "Session-8") ? 'selected' : ''; ?>>Session-8</option>
                                <option value="Session-7" <?php echo ($session == "Session-7") ? 'selected' : ''; ?>>Session-7</option>
                                <option value="Session-6" <?php echo ($session == "Session-6") ? 'selected' : ''; ?>>Session-6</option>
                                <option value="Session-5" <?php echo ($session == "Session-5") ? 'selected' : ''; ?>>Session-5</option>
                                <option value="Session-4" <?php echo ($session == "Session-4") ? 'selected' : ''; ?>>Session-4</option>
                                <option value="Session-3" <?php echo ($session == "Session-3") ? 'selected' : ''; ?>>Session-3</option>
                                <option value="Session-2" <?php echo ($session == "Session-2") ? 'selected' : ''; ?>>Session-2</option>
                                <option value="Session-1" <?php echo ($session == "Session-1") ? 'selected' : ''; ?>>Session-1</option>
                            </select>
                        </div>
